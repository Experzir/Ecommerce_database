    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>รายละเอียดธุรกรรมทั้งหมด</b></h4>
            </div>
            <div class="modal-body">
              ...
              <table class="table table-bordered">
                ...
                <tbody id="detail">
                  <tr>
                    <td colspan="3" align="right"><b>ทั้งหมด</b></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>อัปเดต บัญชี</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="profile_edit.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="contact" class="col-sm-3 control-label">ข้อมูลติดต่อ</label>
                ...
                <div class="form-group">
                    <label for="photo" class="col-sm-3 control-label">ภาพถ่าย</label>
                ...
                <div class="form-group">
                    <label for="curr_password" class="col-sm-3 control-label">ยืนยัน รหัสผ่าน</label>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i>ปิด</button>
              <button type="submit" class="btn btn-success btn-flat" name="edit"><i class="fa fa-check-square-o"></i> อัปเดตข้อมูล</button>
              </form>
            </div>
        </div>
    </div>
